...
contract FlapTest is DSTest {
  ...
  function test_tend() public {
    uint id = flap.kick({lot: 100 ether, bid: 0});
  ...
  function test_deal() public {
    uint id = flap.kick({lot: 400 ether, bid: 0});
  ...
  function test_multiple_auctions() public {
    uint id1 = flap.kick({lot: 200 ether, bid: 0});
    assertEq(flap.fill(), 200 ether);
    uint id2 = flap.kick({lot: 200 ether, bid: 0});
    assertEq(flap.fill(), 400 ether);
