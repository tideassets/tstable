...
contract Flapper {
  ...
  uint public lid; // max dai to be in auction at one time  [rad]
  uint public fill; // current dai in auction                [rad]

  // --- Events ---
  event Kick(uint id, uint lot, uint bid);
